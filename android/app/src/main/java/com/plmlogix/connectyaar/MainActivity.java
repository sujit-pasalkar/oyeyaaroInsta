        ...
        new MethodChannel(getFlutterView(), CHANNEL).setMethodCallHandler(new MethodChannel.MethodCallHandler() {
            ...
            public void onMethodCall(MethodCall methodCall, final MethodChannel.Result result) {
                ...
                if (methodCall.method.equals("compressVideo")) {
                    ...
                    // final String timeStamp = (String) arguments.get("timestamp");

                    // Log.e("in compressVideo method of android:");
                    // Log.error("timeStamp:"+timeStamp);

                    String outDir = Environment.getExternalStorageDirectory().getAbsoluteFile() + "/OyeYaaro" +"/sent";
                    // Log.e("created dir:"+outDir);
                    
                    final String destPath = outDir + File.separator + "VID_" + /* timeStamp */ new SimpleDateFormat("yyyyMMdd_HHmmss", getLocale()).format(new Date()) + ".mp4";
